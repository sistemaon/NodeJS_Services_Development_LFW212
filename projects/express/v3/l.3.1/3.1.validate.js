...
const HOST = 'http://localhost:3000/l-3-1'
...
async function dataCheck () {
  ...
  console.log("🚀 ~ file: 3.1.validate.js:37 ~ dataCheck ~ content:", content)

  console.log("🚀 ~ file: 3.1.validate.js:41 ~ dataCheck ~ data:", data)
  assert.equal(
    content.toString(),
    data,
